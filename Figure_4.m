...
% end
% 
% save('/home/ubuntu/data/bkramer/190218_184A1_EGF/Processed_Data/PID_Normed_18_5.mat','RedundantInformation','UniqueInformation','SynergisticInformation','-v7.3')
% 
% 
% 
...
% end
% 
% save('/home/ubuntu/data/bkramer/190218_184A1_EGF/Processed_Data/PID_Normed_18_1.mat','RedundantInformation','UniqueInformation','SynergisticInformation','-v7.3')
% 
% 
% 
% 
...
% end
% 
% save('/home/ubuntu/data/bkramer/190218_184A1_EGF/Processed_Data/PID_Normed_18_2.mat','RedundantInformation','UniqueInformation','SynergisticInformation','-v7.3')
% 
% 
% 
% 
...
% end
% 
% save('/home/ubuntu/data/bkramer/190218_184A1_EGF/Processed_Data/PID_Normed_18_3.mat','RedundantInformation','UniqueInformation','SynergisticInformation','-v7.3')
% 
% 
% 
...
% end
% 
% save('/home/ubuntu/data/bkramer/190218_184A1_EGF/Processed_Data/PID_Normed_18_4.mat','RedundantInformation','UniqueInformation','SynergisticInformation','-v7.3')

load('Z:\bkramer\190218_184A1_EGF\Processed_Data\PID_Normed_18_2.mat')
...
PairwiseMeanUnique = zeros(10,1);
PairwiseMeanRedundant = zeros(10,1);
PairwiseMeanSynergy = zeros(10,1);

PairwiseMeanEncoding = zeros(30,1);

InsertIndex = 1;
for CurrentResponse = 1:10
        CurrentPairUnique = CurrentUniqueInformation(CurrentResponse,:,:);
        PairwiseMeanUnique(CurrentResponse,1) = mean(CurrentPairUnique(:));   
        
        CurrentPairRedundant = CurrentRedundantInformation(CurrentResponse,:,:);
        PairwiseMeanRedundant(CurrentResponse,1) = mean(CurrentPairRedundant(:)); 
        
        CurrentPairSynergy = CurrentSynergyInformation(CurrentResponse,:,:);
        PairwiseMeanSynergy(CurrentResponse,1) = mean(CurrentPairSynergy(:)); 
        
        PairwiseMeanEncoding(InsertIndex,1) = mean(CurrentPairRedundant(:));
        InsertIndex = InsertIndex + 1;
        PairwiseMeanEncoding(InsertIndex,1) = mean(CurrentPairUnique(:));
        InsertIndex = InsertIndex + 1;
        PairwiseMeanEncoding(InsertIndex,1) = mean(CurrentPairSynergy(:));
        InsertIndex = InsertIndex + 1;
        
end

PlotMatrix = [PairwiseMeanRedundant,PairwiseMeanUnique,PairwiseMeanSynergy];
%PlotMatrix = PlotMatrix./sum(PlotMatrix,2);
...
% ExportPath = ['Z:\bkramer\190218_184A1_EGF\Figures\VF\Reviewer_Figures\ConditionalMutualInfo\RelativeEncoding_NoScaling.pdf'];
...
% Path = ['Z:\bkramer\190218_184A1_EGF\Figures\RevisionFigures\Figure_4\Raw_Figures\','MultiCellular.pdf'];
% export_fig(Path,'-painters')
...
% Path = ['Z:\bkramer\190218_184A1_EGF\Figures\RevisionFigures\Figure_4\Raw_Figures\','Cellular.pdf'];
% export_fig(Path,'-painters')
...
load('Z:\bkramer\180421_184A1_Analysis_6\CleanedData_3.mat')
